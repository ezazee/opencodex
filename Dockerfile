...
# FIX: generate compatibility manifest saat build
...
COPY --from=build --chown=bun:bun /home/bun/app/src/generated/compatibility-version.json ./src/generated/compatibility-version.json
